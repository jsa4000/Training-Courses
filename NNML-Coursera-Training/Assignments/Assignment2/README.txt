...
BIASES are contemplated in the solution. 


1. Input Layer (n = 3) 

	weights (embbed_to_input) = (3,50)

2. Embedding Layer (n = 50)
			
	weights (hidden_to_emmbbed) = (50, 200) -> First layer (since the embbed layers is not using any logistic operation or computing)
	
3. Hidden Layer  (n = 200)

	weights (output_to_Hidden) = (200, 250)


	 => hIDDEN TO OUTPUT -> 250 x 100 . Becasuse the batch size.
	
4. Output layer ( n = 250)
